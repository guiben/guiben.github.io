...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'www/main.data';
  ...
  Module['FS_createPath']("/", "deps", true, true);
Module['FS_createPath']("/deps", "imgui", true, true);
Module['FS_createPath']("/deps/imgui", "misc", true, true);
Module['FS_createPath']("/deps/imgui/misc", "fonts", true, true);
Module['FS_createPath']("/", "res", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_www/main.data');

      };
      Module['addRunDependency']('datafile_www/main.data');
   ...
   loadPackage({"files": [{"filename": "/deps/imgui/misc/fonts/DroidSans.ttf", "start": 0, "end": 190044, "audio": 0}, {"filename": "/deps/imgui/misc/fonts/Cousine-Regular.ttf", "start": 190044, "end": 233956, "audio": 0}, {"filename": "/deps/imgui/misc/fonts/Karla-Regular.ttf", "start": 233956, "end": 250804, "audio": 0}, {"filename": "/deps/imgui/misc/fonts/Roboto-Medium.ttf", "start": 250804, "end": 413392, "audio": 0}, {"filename": "/deps/imgui/misc/fonts/binary_to_compressed_c.cpp", "start": 413392, "end": 426768, "audio": 0}, {"filename": "/deps/imgui/misc/fonts/ProggyTiny.ttf", "start": 426768, "end": 462424, "audio": 0}, {"filename": "/deps/imgui/misc/fonts/ProggyClean.ttf", "start": 462424, "end": 503632, "audio": 0}, {"filename": "/res/img.jpg", "start": 503632, "end": 1634379, "audio": 0}], "remote_package_size": 1634379, "package_uuid": "4c59669f-84f0-456e-b203-734206e10885"});
...
var ASM_CONSTS = {
 ...
 192776: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 192869: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 192938: function() {return screen.width;},  
 192963: function() {return screen.height;},  
 192989: function() {return window.innerWidth;},  
 193019: function() {return window.innerHeight;},  
 193050: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 193145: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 193282: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
